...
class App extends Component {
  state = { loaded: false, cost: 0, itemName: 1 };
  ...
  litenToPaymentEvent = () => {
    const self = this;
    this.itemManager.events.SupplyChainStep().on("data", (event) => {
      self.itemManager.methods.items(event.returnValues._itemIndex).call().then(itemObj => {
